          ...
          <div className="bg-amber-50 rounded-2xl border border-amber-200 p-4 sm:p-5">
            ...
            <div className="space-y-3">
              {pendingEnrollments.map((enrollment) => (
                <div
                  key={enrollment._id}
                  className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 p-3 sm:p-4 bg-white rounded-xl border border-amber-100"
                >
                  ...
                  <div className="flex items-center justify-between sm:flex-col sm:items-end gap-2 sm:gap-0 flex-shrink-0">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gray-100 flex items-center justify-center">
                  <CurrencyRupeeIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-gray-600" />
                </div>
              </div>
              <p className="text-xl sm:text-2xl font-semibold text-gray-800">{stats.total}</p>
            </div>

            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                <p className="text-[10px] sm:text-xs font-medium text-emerald-700 uppercase tracking-wider">
                  Paid
                </p>
              ...
              <p className="text-xl sm:text-2xl font-semibold text-emerald-700">{stats.paid}</p>
            </div>

            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                <p className="text-[10px] sm:text-xs font-medium text-amber-700 uppercase tracking-wider">
                  Pending
                </p>
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-amber-100 flex items-center justify-center">
                  <ClockIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-600" />
                </div>
              </div>
              <p className="text-xl sm:text-2xl font-semibold text-amber-700">{stats.pending}</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-3 sm:p-4">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-emerald-100 flex items-center justify-center">
                  <CurrencyRupeeIcon className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-emerald-600" />
                </div>
              </div>
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-3 sm:p-4">
          <div className="flex flex-col sm:flex-row gap-3">
            <div className="relative flex-1">
              ...
              <input
                type="text"
                placeholder={isStudent ? 'Search by batch or payment ID...' : 'Search by student, batch, or ID...'}
                value={searchQuery}
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full sm:w-auto pl-9 pr-8 py-2.5 bg-gray-50 border border-gray-200 rounded-xl focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100 outline-none transition-all text-sm font-medium text-gray-700 appearance-none cursor-pointer"
              >
